...
export const cypher_decrypt_surmise_chain = surmise.Text.required.to(stamp_model.decrypt)

export function symbol_surmise_chain
(
	pathname: `/${string}`,
...
router.post(
	...
	async function create (req, res)
	{
		...
		await suspect.infer_signed<'mailer', 'cypher'>(
			cypher_decrypt_surmise_chain.signed('cypher'),
