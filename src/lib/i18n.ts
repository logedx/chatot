...
export type SomeLanguage = void | Language


export class Speech<L extends SomeLanguage = void>
{
	#default: string
	...
	local (lang: 'default' | Exclude<L, void>, text: string): void

	// eslint-disable-next-line consistent-return
	local (lang: 'default' | Exclude<L, void>, text?: string): string | void
	{
...
>
{
	...
	// eslint-disable-next-line @typescript-eslint/consistent-indexed-object-style
	constructor (map: T, lang?: { [k in L & Language]?: M })
	{
		this.#map = map
		this.#lang = { ...lang }
