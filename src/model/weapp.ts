...
(
	{
		...
		// 微信小程序SECRET
		secret: {
			type    : database.SensitiveSchemaType,
			required: true,

		},

		// 微信支付MCHID
		mchid: database.SensitiveSchemaType,

		// API v3密钥
		v3key: database.SensitiveSchemaType,

		// 微信支付商户私钥
		sign: database.SensitiveSchemaType,

		// 微信支付商户证书
		evidence: database.SensitiveSchemaType,

		// 微信支付平台证书
		verify: database.SensitiveSchemaType,

		// 微信接口调用令牌 
		token: database.SensitiveSchemaType,

		// 微信接口调用令牌刷新令牌
		refresh: database.SensitiveSchemaType,

		// 微信接口调用令牌过期时间
		expired: database.SensitiveSchemaType,
