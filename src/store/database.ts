...
export class SensitiveSchemaType<T = any, DocType = any> extends SchemaType<T, DocType>
{
	/** This schema type's name, to defend against minifiers that mangle function names. */
	// eslint-disable-next-line @typescript-eslint/naming-convention
	static schemaName: 'SensitiveSchemaType'

	constructor (_path: string, option?: object)
	{
		super(_path, option, 'SensitiveSchemaType')
...
// @ts-ignore
mongoose.Schema.Types.SensitiveSchemaType = SensitiveSchemaType
